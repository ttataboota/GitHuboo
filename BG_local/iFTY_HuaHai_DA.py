...
# ✅ 분석할 유저 설정
TARGET_PLAYER = "iFTY_HuaHai"


telemetry_data=pd.read_json("iFTY_HuaHai_telemetry_data.json",lines=True)


telemetry_data=telemetry_data['data'][3]
...
def is_valid_event(event, required_fields):
